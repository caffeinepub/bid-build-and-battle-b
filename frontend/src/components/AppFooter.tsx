...
export default function AppFooter() {
  ...
  const appId = encodeURIComponent(window.location.hostname || 'bid-build-battle');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            ...
            <span className="font-bold text-sm text-gradient">Bid Build Battle (B³)</span>
          </button>
          ...
          <p className="text-xs text-muted-foreground">© {year} B³. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
