...
export default function TeamRegister() {
  ...
  // Safely read the auction query param — hook must be called at top level
  const rawSearch = useSearch({ strict: false }) as Record<string, string>;
  const auctionId: string | null = rawSearch?.auction ?? null;
          ...
          <div className="w-full max-w-md">
            <div className="card-navy rounded-2xl p-8 shadow-card text-center">
              ...
              <p className="text-muted-foreground text-sm mb-4">
                Your team{" "}
                <span className="text-cyan font-semibold">{teamName}</span> has
                been registered. Awaiting host approval before you can
                participate.
              </p>
          ...
          {auctionId && (
            <div className="flex items-center gap-2 p-3 rounded-lg bg-cyan/10 border border-cyan/20 mb-4">
              ...
              <p className="text-sm text-cyan">
                Valid auction invite link detected
              </p>
            </div>
          )}
          ...
          {!auctionId && (
            <div className="flex items-center gap-2 p-3 rounded-lg bg-chart-4/10 border border-chart-4/20 mb-4">
              ...
              <p className="text-sm text-chart-4">
                No auction ID found. You may still register.
              </p>
            </div>
          )}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.teamName)
                        setErrors((p) => ({ ...p, teamName: undefined }));
                    }}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.ownerName)
                        setErrors((p) => ({ ...p, ownerName: undefined }));
                    }}
